...
var paginate = function paginate(schema) {
  ...
  schema.statics.paginate = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(filter, options) {
          ...
          case 0:
            ...
            if (options.sortBy) {
              ...
              options.sortBy.split(',').forEach(function (sortOption) {
                var _sortOption$split = sortOption.split(':'),
                  _sortOption$split2 = _slicedToArray(_sortOption$split, 2),
                  key = _sortOption$split2[0],
                  order = _sortOption$split2[1];
            ...
            return _context.abrupt("return", Promise.all([countPromise, docsPromise]).then(function (values) {
              var _values = _slicedToArray(values, 2),
                totalResults = _values[0],
                results = _values[1];
