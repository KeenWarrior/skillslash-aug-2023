 ...
 * @returns {string}
 */
var generateToken = function generateToken(userId, expires, type) {
...
var generateAuthTokens = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          accessToken = generateToken(user.id, accessTokenExpires, tokenTypes.ACCESS);
          ...
          _context3.next = 6;
          return saveToken(refreshToken, user.id, refreshTokenExpires, tokenTypes.REFRESH);
        case 6:
  ...
  return function generateAuthTokens(_x7) {
...
var generateResetPasswordToken = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 5:
          ...
          resetPasswordToken = generateToken(user.id, expires, tokenTypes.RESET_PASSWORD);
          _context4.next = 9;
          return saveToken(resetPasswordToken, user.id, expires, tokenTypes.RESET_PASSWORD);
        case 9:
          return _context4.abrupt("return", resetPasswordToken);
        case 10:
        case "end":
  ...
  return function generateResetPasswordToken(_x8) {
...
var generateVerifyEmailToken = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(user) {
    var expires, verifyEmailToken;
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          expires = moment().add(config.jwt.verifyEmailExpirationMinutes, 'minutes');
          verifyEmailToken = generateToken(user.id, expires, tokenTypes.VERIFY_EMAIL);
          _context5.next = 4;
          return saveToken(verifyEmailToken, user.id, expires, tokenTypes.VERIFY_EMAIL);
        case 4:
          return _context5.abrupt("return", verifyEmailToken);
        case 5:
        case "end":
  ...
  return function generateVerifyEmailToken(_x9) {
