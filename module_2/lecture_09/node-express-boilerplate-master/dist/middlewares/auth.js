...
var _require = require('../config/roles'),
  roleRights = _require.roleRights;
var verifyCallback = function verifyCallback(req, resolve, reject, requiredRights) {
  return /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(err, user, info) {
      var userRights, hasRequiredRights;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            hasRequiredRights = requiredRights.every(function (requiredRight) {
            ...
            return _context.abrupt("return", reject(new ApiError(httpStatus.FORBIDDEN, 'Forbidden')));
          case 8:
            resolve();
          case 9:
          case "end":
